...
// Side effect imports
            ...
            /* WEBPACK VAR INJECTION */
        }.call(exports, __webpack_require__(142)(module)))
    ...
    /***/ (function (module, exports) {
        ...
        module.exports = {
            ...
            buildModalButton: document.querySelector("#buildModalButton"),
            diceResult: document.querySelector("#diceResult"),
            finishTurn: document.querySelector("#finishTurn"),
            buyModal: document.querySelector("#buyModal"),
            buyButton: document.querySelector("#buyButton"),
            propertiesModal: document.querySelector("#propertiesModal"),
            requestBuild: document.querySelector("#buildActionButton"),
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        const gameId = __webpack_require__(2);
        const updateLogScroll = __webpack_require__(3);
        const updateChatScroll = __webpack_require__(8);
        const finish = __webpack_require__(132);
        const userId = __webpack_require__(4);
        const wantToBuy = __webpack_require__(9);
        const initGame = __webpack_require__(10);
        const log = __webpack_require__(135);
        const askProperties = __webpack_require__(11);
        const properties = __webpack_require__(136);
        const displayHouses = __webpack_require__(12);
        const requestBuild = __webpack_require__(137);
        const leaveGame = __webpack_require__(138);

        let socket = null;

        const init = () => {
            socket = __webpack_require__(139)();
        };
...
//PlayerButtons
    ...
    ELEMENTS.playerButton.addEventListener("click", askProperties);
        ...
        module.exports = {
            ...
            displayHouses,
            leaveGame,
            wantToBuy: __webpack_require__(9),
            //Socket.on
            start: __webpack_require__(144),
            gameInit: __webpack_require__(10),
            diceRolled: __webpack_require__(145),
            turnFinished: __webpack_require__(146),
            bought: __webpack_require__(147),
            buy: __webpack_require__(148)
        };
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        const ELEMENTS = __webpack_require__(1);
        const updateLogScroll = __webpack_require__(3);
        const updatePiecePosition = __webpack_require__(5);
        const userId = __webpack_require__(4);
        const askProperties = __webpack_require__(11);
        const payJail = __webpack_require__(133);
        const useJailCard = __webpack_require__(134);
        const roll = __webpack_require__(7);
        const displayHouses = __webpack_require__(12);
...
//! author : Chris Lam : https://github.com/hehachris
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        const GameManager = __webpack_require__(6);
        GameManager.init();
...
//$("#buildModalButton").bind('click', wantToBuild());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__.d(__webpack_exports__, "appendMessage", function () {
            return appendMessage;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "messageElement", function () {
            return messageElement;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "timestampElement", function () {
            return timestampElement;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "userElement", function () {
            return userElement;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "userJoined", function () {
            return userJoined;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "userLeft", function () {
            return userLeft;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "messageReceived", function () {
            return messageReceived;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "updateChatScroll", function () {
            return updateChatScroll;
        });
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_0_moment__ = __webpack_require__(0);
        /* harmony import */
        ...
        const timestampElement = time => {
            const element = $('<time>', {
                class: 'timeago',
                datetime: __WEBPACK_IMPORTED_MODULE_0_moment___default()(time).format()
            }).text(__WEBPACK_IMPORTED_MODULE_0_moment___default()(time).format('hh:mm:ss'));
